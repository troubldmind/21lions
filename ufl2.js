...
$(document).ready(function(){document.title='United Football League';if($('.nav.pull-right li a:contains("Register")').length>0){if(document.URL.toLowerCase().indexOf("daddyleagues.com/ufl/coaches")>=0){$('.data-table1').remove();}}
...
$('.no>a:contains("New Orleans Saints")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/no"> N.O.</a>');
$('.nyj>a:contains("New York Jets")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/nyj"> NYJ</a>');
$('.mia>a:contains("Miami Dolphins")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/mia"> MIA</a>');
$('.cle>a:contains("Cleveland Browns")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/cle"> CLE</a>');
$('.cin>a:contains("Cincinnati Bengals")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/cin"> CIN</a>');
$('.bal>a:contains("Baltimore Ravens")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/bal">BAL</a>');
$('.ten>a:contains("Tennessee Titans")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/ten"> TENN</a>');
$('.ind>a:contains("Indianapolis Colts")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/ind"> IND</a>');
$('.hou>a:contains("Houston Texans")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/hou"> HOU</a>');
$('.oak>a:contains("Oakland Raiders")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/oak"> OAK</a>');
$('.den>a:contains("Denver Broncos")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/den">DEN</a>');
$('.kc>a:contains("Kansas City Chiefs")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/kc"> KC</a>');
$('.dal>a:contains("Dallas Cowboys")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/dal"> DAL</a>');
$('.nyg>a:contains("New York Giants")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/nyg"> NYG</a>');
$('.det>a:contains("Detroit Lions")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/det"> DET</a>');
$('.gb>a:contains("Green Bay Packers")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/GB"> GB</a>');
$('.min>a:contains("Minnesota Vikings")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/min">MIN</a>');
$('.chi>a:contains("Chicago Bears")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/chi"> CHI</a>');
$('.car>a:contains("Carolina Panthers")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/car"> CAR</a>');
$('.atl>a:contains("Atlanta Falcons")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/atl"> ATL</a>');
$('.stl>a:contains("St. Louis Rams")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/stl"> STL</a>');
$('.sea>a:contains("Seattle Seahawks")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/sea"> SEA</a>');
$('.arz>a:contains("Arizona Cardinals")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/ari"> ARI</a>');
$('.buf>a:contains("Buffalo Bills")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/buf"> BUF</a>');
$('.pit>a:contains("Pittsburgh Steelers")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/pit"> PIT</a>');
$('.sf>a:contains("San Francisco 49ers")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/sf"> SF</a>');
$('.was>a:contains("Washington Redskins")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/was"> WAS</a>');
$('.sd>a:contains("San Diego Chargers")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/sd"> SD</a>');
$('.jac>a:contains("Jacksonville Jaguars")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/jac"> JAC</a>');
$('.ne>a:contains("New England Patriots")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/ne"> NE</a>');
$('.tb>a:contains("Tampa Bay Buccaneers")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/tb"> TB</a>');
$('.phi>a:contains("Philadelphia Eagles")').replaceWith('<a href="http://daddyleagues.com/tnevix1/team/phi"> PHI</a>');
