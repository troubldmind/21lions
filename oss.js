...
$(document).ready(function(){document.title='OSS';if($('.nav.pull-right li a:contains("Register")').length>0){if(document.URL.toLowerCase().indexOf("daddyleagues.com/OSS/coaches")>=0){$('.data-table1').remove();}}
$('.maincontent').addClass('clearfix');

$('a>span:contains("ari")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/ari.png" width="16" height="12"" class="scoreboard"> Cardinals</span>');
$('a>span:contains("atl")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/atl.png" width="16" height="12"" class="scoreboard"> Falcons</span>');
$('a>span:contains("bal")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/bal.png" width="16" height="12"" class="scoreboard"> Ravens</span>');
$('a>span:contains("buf")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/buf.png" width="16" height="12"" class="scoreboard"> Bills</span>');
$('a>span:contains("car")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/car.png" width="16" height="12"" class="scoreboard"> Panthers</span>');
$('a>span:contains("chi")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/chi.png" width="16" height="12"" class="scoreboard"> Bears</span>');
$('a>span:contains("cin")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/cin.png" width="16" height="12"" class="scoreboard"> Bengals</span>');
$('a >span:contains("cle")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/cle.png" width="16" height="12""" class="scoreboard"> Browns</span>');
$('a>span:contains("dal")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/dal.png" width="16" height="12"" class="scoreboard"> Cowboys</span>');
$('a>span:contains("den")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/den.png" width="16" height="12"" class="scoreboard"> Broncos</span>');
$('a>span:contains("det")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/det.png" width="16" height="12"" class="scoreboard"> Lions</span>');
$('a>span:contains("gb")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/gb.png" width="16" height="12"" class="scoreboard"> Packers</span>');
$('a>span:contains("hou")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/hou.png" width="16" height="12"" class="scoreboard"> Texans</span>');
$('a>span:contains("ind")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/ind.png" width="16" height="12"" class="scoreboard"> Colts</span>');
$('a>span:contains("jac")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/jac.png" width="16" height="12"" class="scoreboard"> Jaguars</span>');
$('a>span:contains("kc")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/kc.png" width="16" height="12"" class="scoreboard"> Chiefs</span>');
$('a>span:contains("mia")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/mia.png" width="16" height="12"" class="scoreboard"> Dolphins</span>');
$('a>span:contains("min")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/min.png" width="16" height="12"" class="scoreboard">  Vikings</span>');
$('a>span:contains("ne")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/ne.png"width="16" height="12"" class="scoreboard"> Patriots</span>');
$('a>span:contains("no")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/no.png" width="16" height="12"" class="scoreboard"> Saints</span>');
$('a>span:contains("nyg")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/nyg.png" width="16" height="12"" class="scoreboard"> Giants</span>');
$('a>span:contains("nyj")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/nyj.png" width="16" height="12"" class="scoreboard"> Jets</span>');
$('a>span:contains("oak")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/oak.png" width="16" height="12"" class="scoreboard"> Raiders</span>');
$('a>span:contains("phi")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/phi.png" width="16" height="12"" class="scoreboard"> Eagles</span>');
$('a>span:contains("pit")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/pit.png" width="16" height="12"" class="scoreboard"> Steelers</span>');
$('a>span:contains("sd")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/sd.png" width="16" height="12"" class="scoreboard"> Chargers</span>');
$('a>span:contains("sf")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/sf.png" width="16" height="12"" class="scoreboard"> 49ers</span>');
$('a>span:contains("sea")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/sea.png" width="16" height="12"" class="scoreboard"> Seahawks</span>');
$('a>span:contains("stl")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/stl.png" width="16" height="12"" class="scoreboard"> Rams</span>');
$('a>span:contains("tb")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/tb.png" width="16" height="12"" class="scoreboard"> Bucs</span>');
$('a>span:contains("ten")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/ten.png" width="16" height="12"" class="scoreboard"> Titans</span>');
$('a>span:contains("was")').replaceWith('<img src="http://i.nflcdn.com/static/site/6.9/img/logos/teams-gloss-81x54/was.png" width="16" height="12"" class="scoreboard"> Redskins</span>');
...
$('.data-table1 td:contains("Eagles")').prepend('<img src="http://www.mghelmets.com/logos/phi-eagles.png" width="25" height="21" border="0" alt="Team logo" class="teamLogo">').addClass("phi");
...
$('.data-table1 td:contains("49ers")').prepend('<img src="http://www.mghelmets.com/logos/sf-49ers.png" width="26" height="21" border="0" alt="Team logo" class="teamLogo">').addClass("sf");
...
$('.data-table1 td:contains("Rams")').prepend('<img src="http://www.mghelmets.com/logos/stl-rams.png" width="26    " height="21"border="0" alt="Team logo" class="teamLogo">').addClass("stl");
        ...
        $.getJSON("https://api.twitch.tv/kraken/streams/"+twitch+".json?callback=?", function(c) {
            if (c.stream == null) {
                ...
                if ( ! $('#twitchList li').length ){
                   $('#twitchList').html('<li class="online">Currently, no teams are streaming. Check back later...</li>');
                }   
            } else {
...
$('.no>a:contains("New Orleans Saints")').replaceWith('<a href="http://daddyleagues.com/OSS/team/no"> N.O.</a>');
$('.nyj>a:contains("New York Jets")').replaceWith('<a href="http://daddyleagues.com/OSS/team/nyj"> NYJ</a>');
$('.mia>a:contains("Miami Dolphins")').replaceWith('<a href="http://daddyleagues.com/OSS/team/mia"> MIA</a>');
$('.cle>a:contains("Cleveland Browns")').replaceWith('<a href="http://daddyleagues.com/OSS/team/cle"> CLE</a>');
$('.cin>a:contains("Cincinnati Bengals")').replaceWith('<a href="http://daddyleagues.com/OSS/team/cin"> CIN</a>');
$('.bal>a:contains("Baltimore Ravens")').replaceWith('<a href="http://daddyleagues.com/OSS/team/bal">BAL</a>');
$('.ten>a:contains("Tennessee Titans")').replaceWith('<a href="http://daddyleagues.com/OSS/team/ten"> TENN</a>');
$('.ind>a:contains("Indianapolis Colts")').replaceWith('<a href="http://daddyleagues.com/OSS/team/ind"> IND</a>');
$('.hou>a:contains("Houston Texans")').replaceWith('<a href="http://daddyleagues.com/OSS/team/hou"> HOU</a>');
$('.oak>a:contains("Oakland Raiders")').replaceWith('<a href="http://daddyleagues.com/OSS/team/oak"> OAK</a>');
$('.den>a:contains("Denver Broncos")').replaceWith('<a href="http://daddyleagues.com/OSS/team/den">DEN</a>');
$('.kc>a:contains("Kansas City Chiefs")').replaceWith('<a href="http://daddyleagues.com/OSS/team/kc"> KC</a>');
$('.dal>a:contains("Dallas Cowboys")').replaceWith('<a href="http://daddyleagues.com/OSS/team/dal"> DAL</a>');
$('.nyg>a:contains("New York Giants")').replaceWith('<a href="http://daddyleagues.com/OSS/team/nyg"> NYG</a>');
$('.det>a:contains("Detroit Lions")').replaceWith('<a href="http://daddyleagues.com/OSS/team/det"> DET</a>');
$('.gb>a:contains("Green Bay Packers")').replaceWith('<a href="http://daddyleagues.com/OSS/team/GB"> GB</a>');
$('.min>a:contains("Minnesota Vikings")').replaceWith('<a href="http://daddyleagues.com/OSS/team/min">MIN</a>');
$('.chi>a:contains("Chicago Bears")').replaceWith('<a href="http://daddyleagues.com/OSS/team/chi"> CHI</a>');
$('.car>a:contains("Carolina Panthers")').replaceWith('<a href="http://daddyleagues.com/OSS/team/car"> CAR</a>');
$('.atl>a:contains("Atlanta Falcons")').replaceWith('<a href="http://daddyleagues.com/OSS/team/atl"> ATL</a>');
$('.stl>a:contains("St. Louis Rams")').replaceWith('<a href="http://daddyleagues.com/OSS/team/stl"> LA</a>');
$('.sea>a:contains("Seattle Seahawks")').replaceWith('<a href="http://daddyleagues.com/OSS/team/sea"> SEA</a>');
$('.arz>a:contains("Arizona Cardinals")').replaceWith('<a href="http://daddyleagues.com/OSS/team/ari"> ARI</a>');
$('.buf>a:contains("Buffalo Bills")').replaceWith('<a href="http://daddyleagues.com/OSS/team/buf"> BUF</a>');
$('.pit>a:contains("Pittsburgh Steelers")').replaceWith('<a href="http://daddyleagues.com/OSS/team/pit"> PIT</a>');
$('.sf>a:contains("San Francisco 49ers")').replaceWith('<a href="http://daddyleagues.com/OSS/team/sf"> SF</a>');
$('.was>a:contains("Washington Redskins")').replaceWith('<a href="http://daddyleagues.com/OSS/team/was"> WAS</a>');
$('.sd>a:contains("San Diego Chargers")').replaceWith('<a href="http://daddyleagues.com/OSS/team/sd"> SD</a>');
$('.jac>a:contains("Jacksonville Jaguars")').replaceWith('<a href="http://daddyleagues.com/OSS/team/jac"> JAC</a>');
$('.ne>a:contains("New England Patriots")').replaceWith('<a href="http://daddyleagues.com/OSS/team/ne"> NE</a>');
$('.tb>a:contains("Tampa Bay Buccaneers")').replaceWith('<a href="http://daddyleagues.com/OSS/team/tb"> TB</a>');
$('.phi>a:contains("Philadelphia Eagles")').replaceWith('<a href="http://daddyleagues.com/OSS/team/phi"> PHI</a>');
